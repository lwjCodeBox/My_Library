...
#define MARGIN_MAXIMIZED	0

// CSkinDialog dialog
IMPLEMENT_DYNAMIC(CSkinDialog, CDialogEx)

CSkinDialog::CSkinDialog(UINT nResourceID, CWnd* pParent /*=nullptr*/)
...
LRESULT CSkinDialog::OnEnterSizeMove(WPARAM wParam, LPARAM lParam)
{
	...
	if (!m_bDraging)
	{
		...
		Global.SetLayeredWindowAttributes(m_hWnd, 0, 100, LWA_ALPHA);
